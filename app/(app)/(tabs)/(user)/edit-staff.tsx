...
const EditStaffScreen: React.FC = () => {
  ...
  const [staffData, setStaffData] = useState<SalonStaffType | null>(staff ? JSON.parse(String(staff)) : null);
  ...
  const { control, handleSubmit, formState: { errors }, reset } = useForm<UpdateSalonStaffInput>({
    defaultValues: {
      first_name: staffData?.first_name || '',
      email: staffData?.email || '',
      phone: staffData?.phone || '',
      salon_id: staffData?.salon?.id || selectedSalon?.id,
      commission_rate: Number(staffData?.commission_rate) || 0,
      id: staffData?.id
  ...
  const handleUpdateStaff = async (data:UpdateSalonStaffInput) => {
    try {
      setIsLoading(true);
      ...
      await salonAPI.updateSalonStaff(data);

      Alert.alert('Success', 'Staff is updated successfully');
        ...
        <ScrollView style={styles.form}>
              ...
              <>
                <View style={styles.inputContainer}>
                  ...
                  <TextInput
                    ...
                    onChangeText={onChange}
                    value={String(value)}
                    editable={staffData?.email ? false : true}
                  />
                  {errors.email && (
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={handleSubmit(handleUpdateStaff)}
              disabled={isLoading}
            >
